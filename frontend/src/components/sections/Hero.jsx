function Hero() {
    return (
        <div>
            <div className="bg-[#F5F5F5] mx-auto flex flex-row text-[#3B3C4A] py-5 px-16">
                <div className="flex flex-col gap-6 w-2/3">
                    <div className="flex flex-col gap-1">
                        <span className="text-4xl font-thin">Hey!</span>
                        <span className="text-4xl font-thin">We are <strong>Interlink</strong></span>
                        <span className="text-xl font-thin">Forge Connections. Unlock Internships. Thrive.</span>
                        <span className="font-light">InterLink is a user-friendly website that connects ambitious students and recent graduates with exciting internship opportunities across various industries. Whether you are looking to gain hands-on experience, kickstart your career, or explore your passions, our platform curates a diverse range of internships from renowned companies and startups alike.</span>
                    </div>
                    <a href="#">
            ...
            <div className=" mx-auto px-16 overflow-x-hidden">
                ...
                <div className="overflow-x-hidden flex flex-row justify-between w-11/12 mt-6">
                    ...
                    <div className="hover:text-white bg-[#edededda] hover:bg-gradient-to-r hover:from-[#112b4f] hover:via-slate-700 hover:to-[#112b4f] w-4/12 h-[275px] rounded-[30px] flex flex-col p-12 gap-8">
                        ...
                        <h2>Lorem ipsum dolor sit amet consectetur adipisicing elit. Saepe, mollitia quibusdam porro deserunt pariatur</h2>
                    </div>
