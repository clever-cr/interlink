...
function Home() {
  return (
    <div>
      <div className="bg-[#F5F5F5]  flex flex-row text-[#3B3C4A]- py-8 px-16  ">
        <div className="flex flex-col gap-6 w-2/3">
          <div className="flex flex-col gap-5 pt-12">
            <span className="text-5xl font-light text-[#141624]">Hey!</span>
            <span className="text-5xl font-thin">
              We're <strong className="text-[#141624]">Interlink</strong>
            </span>

            <span className="font-light text-[20px] max-w-3xl">
      ...
      <div className="px-16  text-[#3B3C4A] py-16">
        <div className="flex justify-between items-center">
          ...
          <div className="bg-blue-200]">
            <div className="border-2  border-grey-700 rounded-lg p-3 pt-8 shadow-md relative w-[512px] h-[260px]">
              <div
      ...
      <div className="px-16  text-[#3B3C4A] py-12">
